...
AS ANÁLISES DE DADOS TEM COMO FOCO ENTENDER OS INDICADOES DE QUALIDADE DE ATENDIMENTO AO CLIENTE (CX), UTILIZANDO SQL PARA MODELAGEM CONSULTA E GERAÇÃO DE MÉTRICAS OPERACIONAIS"
